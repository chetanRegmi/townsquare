...
const httpLink = new HttpLink({
  uri: 'https://townsquare-server.vercel.app/api/graphql', // GraphQL server URL
  Authorization: `Bearer ${localStorage.getItem('token')}`,
});

// Create a WebSocket link for subscriptions
const wsLink = new WebSocketLink({
  uri: 'wss://townsquare-server.vercel.app/api/graphql', // WebSocket URL for GraphQL subscriptions
  options: {
